...
* [schemaVersion](title.md#optional-schemaversion)
* [value](title.md#value)

### Methods

* [equals](title.md#equals)
* [getActions](title.md#getactions)
* [getHook](title.md#gethook)
* [getHookOrThrow](title.md#gethookorthrow)
* [getHooks](title.md#gethooks)
* [getLegacyTransformer](title.md#getlegacytransformer)
* [getLegacyTransformers](title.md#getlegacytransformers)
* [getPropTypes](title.md#getproptypes)
* [getPropertyInitializers](title.md#getpropertyinitializers)
* [getSchemaVersion](title.md#getschemaversion)
* [getTypeName](title.md#gettypename)
* [hasAction](title.md#hasaction)
* [hasHook](title.md#hashook)
* [hasLegacyTransformer](title.md#haslegacytransformer)
* [in](title.md#in)
* [overrideHook](title.md#overridehook)
* [overrideLegacyTransformer](title.md#overridelegacytransformer)
* [processSerializableList](title.md#processserializablelist)
* [registerHook](title.md#registerhook)
* [registerLegacyTransformer](title.md#registerlegacytransformer)
* [removeHook](title.md#removehook)
* [toJSONValue](title.md#tojsonvalue)
* [toPlainObject](title.md#toplainobject)
* [toString](title.md#tostring)
* [transformLegacyProps](title.md#transformlegacyprops)
* [typeName](title.md#typename)
* [validateProps](title.md#validateprops)
* [disableSerializableLists](title.md#static-disableserializablelists)
* [enableSerializableLists](title.md#static-enableserializablelists)
* [from](title.md#static-from)
* [getPropTypes](title.md#static-getproptypes)
* [getPropertyInitializers](title.md#static-getpropertyinitializers)
* [getTypeName](title.md#static-gettypename)
* [toString](title.md#static-tostring)
* [typeName](title.md#static-typename)

## Constructors

###  constructor

\+ **new Title**(`arg`: object | string): *[Title](title.md)*
...
------ | ------ | ------ |
`arg` | object &#124; string | Object with value property or string.  |

**Returns:** *[Title](title.md)*
...
*Overrides [RegisterCustomer](registercustomer.md).[toString](registercustomer.md#tostring)*
